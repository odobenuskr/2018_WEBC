...
memberObj3 = fs.readFileSync('member.json');
...
console.log('\n- 객체 주민번호(rrid)로 정렬');
const outputB = _.sortBy(memberObj3, (item) => item.name);
console.log(outputB);
...
memberObj4 = [];
mappedMemberObj.forEach((item, index) => { /* 이 위치에 구현  */         });
console.log('\n(memberObj4)');
console.log(memberObj4);
memberObj4.forEach((item, index) => { /* 이 위치에 구현   */        });
console.log('\n(memberObj4)');
console.log(memberObj4);
